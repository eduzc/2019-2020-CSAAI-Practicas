...
def IsoDigitRec(protoFSeq, patt_to_rec = 'upattern01'):
    ...
    #os.chdir("./tema6_tecnologias_del_habla/data/")
    protoNames=['zero.wav','one.wav','two.wav','three.wav','four.wav','five.wav','six.wav','seven.wav','eight.wav','nine.wav']
    ...
    for proto in protoFSeq:
        ...
        #TO_DO control cols = number of features, rows = number of points
        NodeCost, D, path, cost_a, matching_cost_a = dtw_Endp(proto.T,Ftest.T,omit_left=LeftEndConstr, omit_right=RightEndConstr)
